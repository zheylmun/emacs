...
[[https://github.com/Andersbakken/rtags][RTags]] is a C/C++ indexer which uses the compilation commands and clang frontend to ensure that the indexing is accurate.
